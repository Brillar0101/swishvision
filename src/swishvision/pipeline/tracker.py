...
from swishvision.pipeline.team_classifier import get_player_crops
...
from swishvision.pipeline.team_classifier import TeamClassifier as FallbackTeamClassifier
...
from swishvision.pipeline.tactical import TacticalView, create_combined_view
from swishvision.data.team_rosters import TEAM_ROSTERS, TEAM_COLORS, get_player_name
from swishvision.pipeline.path_smoothing import smooth_tactical_positions
from swishvision.pipeline.jersey import ConsecutiveValueTracker
...
BYTETRACK_MINIMUM_MATCHING_THRESHOLD = 0.6
...
class PlayerTracker:
    ...
    def _generate_portfolio_frames(
        ...
        """
        from swishvision.pipeline.tactical import draw_court
